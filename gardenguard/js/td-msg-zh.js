...
_TD.a.push(function (TD) {
	...
	TD._msg_texts = {
		...
		"panel_monster_title": "穿行者: ",
		"building_name_wall": "高滚门",
		"building_name_cannon": "热心群众",
		"building_name_LMG": "普通群众",
		"building_name_HMG": "业主委员会",
		"building_name_laser_gun": "物业",
		"building_info": "${0}: 等级 ${1}，攻击 ${2}，速度 ${3}，射程 ${4}，战绩 ${5}",
		"building_info_wall": "${0}",
		"building_intro_wall": "高滚门 可以阻止穿行者通过 ($${0})",
		"building_intro_cannon": "热心群众 射程、杀伤力较为平衡 ($${0})",
		"building_intro_LMG": "普通群众 射程较远，杀伤力一般 ($${0})",
		"building_intro_HMG": "业主委员会 快速射击，威力较大，射程一般 ($${0})",
		"building_intro_laser_gun": "物业 伤害较大，命中率 100% ($${0})",
		"click_to_build": "左键点击建造 ${0} ($${1})",
		"upgrade": "升级 ${0} 到 ${1} 级，需花费 $${2}。",
		"sell": "出售 ${0}，可获得 $${1}",
		"upgrade_success": "升级成功，${0} 已升级到 ${1} 级！下次升级需要 $${2}。",
		"monster_info": "${4}: 生命 ${0}，防御 ${1}，速度 ${2}，伤害 ${3}",
