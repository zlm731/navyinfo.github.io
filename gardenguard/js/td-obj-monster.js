...
//		if (!this.map) return;
		...
		beHit: function (building, damage) {
			...
			if (balloontip.el == this) {
				balloontip.text = TD._t("monster_info", [this.life, this.shield, this.speed, this.damage, this.display_name]);
			}
		...
		onEnter: function () {
			...
			if (balloontip.el == this) {
				...
				msg = TD._t("monster_info",
					[this.life, this.shield, this.speed, this.damage, this.display_name]);
